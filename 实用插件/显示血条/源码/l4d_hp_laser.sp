...
public void OnPluginStart()
{
    ...
    g_hCvar_AlignCenter       = CreateConVar("l4d_hp_laser_align_center", "0", "0 = Align the laser left-to-right per client eye angles. (lower performance)\n1 = Align the laser to center. (better performance)", CVAR_FLAGS, true, 0.0, true, 1.0);
    ...
    g_hCvar_Model             = CreateConVar("l4d_hp_laser_model", "vgui/white_additive.vmt", "Model of the laser beam HP.");
    ...
    g_hCvar_SurvivorTeam      = CreateConVar("l4d_hp_laser_survivor_team", "2", "Which teams survivors can see a laser beam HP.\n0 = NONE, 1 = SURVIVOR, 2 = INFECTED, 4 = SPECTATOR, 8 = HOLDOUT.\nAdd numbers greater than 0 for multiple options.\nExample: \"3\", enables for SURVIVOR and INFECTED.", CVAR_FLAGS, true, 0.0, true, 15.0);
    g_hCvar_InfectedTeam      = CreateConVar("l4d_hp_laser_infected_team", "2", "Which teams infected can see a laser beam HP.\n0 = NONE, 1 = SURVIVOR, 2 = INFECTED, 4 = SPECTATOR, 8 = HOLDOUT.\nAdd numbers greater than 0 for multiple options.\nExample: \"3\", enables for SURVIVOR and INFECTED.", CVAR_FLAGS, true, 0.0, true, 15.0);
